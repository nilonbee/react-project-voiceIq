...
<div className="row align-self-center">
    <div className="col-lg-12 justify-self-center"  >
        ...
        <Title title="Register Free Today" />
          ...
          <fieldset className="shadow-lg p-3 mb-5 bg-body rounded" style={{  backgroundImage:"linear-gradient(to right,#eee,#FFFFFF)",padding:25,borderRadius:28,textShadow:7}} >  
